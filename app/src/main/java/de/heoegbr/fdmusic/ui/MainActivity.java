...
public class MainActivity extends AppCompatActivity {
    ...
    private Timer timer;
    private int currentTimeInMusic;
    ...
    public class MusicViewAdapter extends RecyclerView.Adapter<MusicEntryPointViewHolder> {
        ...
        public void onBindViewHolder(@NonNull MusicEntryPointViewHolder holder, int position) {
            ...
            holder.itemView.setOnClickListener(v -> {
                ...
                int startTime = LazyDatabase.FORMATION_DATA.entryPoints.get(position).start;

                int leadTime = sLeadTimeInSeconds * 1000;
                ...
                timer.scheduleAtFixedRate(new TimerTask() {
                    ...
                    public void run() {
                        ...
                        currentTimeInMusic = (int) (currentTimeInMusic + sSpeed * (now - lastTime));
                        lastTime = now;
